...
```
  ...
  - [3. Probleme von Kameralistik und herkömmlichem NKF](#3-probleme-von-kameralistik-und-herkmmlichem-nkf)
      ...
      - [3.2.1 Problem (NKF): Kassenorientierung  als disfunktionales Anreizsystem](#321-problem-nkf-kassenorientierung--als-disfunktionales-anreizsystem)
      - [3.2.2 Lösung (iNKF): Produkt- und Gemeinwohlorientierung](#322-lsung-inkf-produkt--und-gemeinwohlorientierung)
      - [3.3.1 Problem (NKF): Komplex und kompliziert](#331-problem-nkf-komplex-und-kompliziert)
        - [Negativbeispiel: Hierarchien in Matrixstruktur](#negativbeispiel-hierarchien-in-matrixstruktur)
      - [3.3.2 Lösung (iNKF): Spezifische Rechnungslegung implementiert](#332-lsung-inkf-spezifische-rechnungslegung-implementiert)
      - [3.4.1 Problem: Streit um die „richtige“ Rechnungslegung](#341-problem-streit-um-die-richtige-rechnungslegung)
      - [3.4.2 Lösung (iNKF): Trennung von Fakten und Interpretationen](#342-lsung-inkf-trennung-von-fakten-und-interpretationen)
    - [3.4  Übergeordnete Ziele](#34--bergeordnete-ziele)
      - [3.4.1 Kooperation](#341-kooperation)
      - [3.4.2 Synergieeffekte schaffen](#342-synergieeffekte-schaffen)
      - [3.4.3 Gemeinsame konstruktive Politik](#343-gemeinsame-konstruktive-politik)
      - [3.4.4 Berichte](#344-berichte)
  - [4 Technologie](#4-technologie)
    ...
    - [4.2 Digitale Infrastruktur-Architektur](#42-digitale-infrastruktur-architektur)
      - [4.2.X Linked (Open) Data](#42x-linked-open-data)
      - [4.2.X Agile Software-Entwicklung, agile Daten](#42x-agile-software-entwicklung-agile-daten)
      - [4.2.X. ETL](#42x-etl)
      - [4.3.1 Transparenz und Komplexitätsreduktion](#431-transparenz-und-komplexittsreduktion)
      - [4.3.2 Betrachter*-Schnittstelle (UI für die Bürger*)](#432-betrachter-schnittstelle-ui-fr-die-brger)
  - [5 Marktlage](#5-marktlage)
    - [](#)
      - [5.1.1 Problem:](#511-problem)
      - [5.1.2 Lösung:](#512-lsung)
      - [5.2.1 Problem:](#521-problem)
      - [5.2.2 Lösung:](#522-lsung)
        - [Negativ-Beispiele](#negativ-beispiele)
  - [6. Technische Details](#6-technische-details)
    - [6.1 Buchhaltung](#61-buchhaltung)
        - [2.2.1.3 Die Rechengröße „Aufwand“](#2213-die-rechengre-aufwand)
      - [6.1.2 So einfach wie möglich: Buchungsebenen beachten](#612-so-einfach-wie-mglich-buchungsebenen-beachten)
      - [6.1.2 …, aber nicht einfacher: Kosten- und Leistungsrechnung](#612--aber-nicht-einfacher-kosten--und-leistungsrechnung)
      - [6.1.3 Transparenz: Klare Trennung zwischen Politik und Verwaltung](#613-transparenz-klare-trennung-zwischen-politik-und-verwaltung)
      - [6.1.4 Qualität buchen: Der fehlende Baustein der Rechnungslegung](#614-qualitt-buchen-der-fehlende-baustein-der-rechnungslegung)
      - [6.1.4. Vermögensrelevante Geschäftsvorfälle](#614-vermgensrelevante-geschftsvorflle)
      - [5.2.3 Zielorientierte Planung, Durchführung und Kontrolle](#523-zielorientierte-planung-durchfhrung-und-kontrolle)
      - [5.2.4 Die Grundideen der multidimensionalen Buchhaltung](#524-die-grundideen-der-multidimensionalen-buchhaltung)
        - [5.2.4.5 Abstrahieren – Spezialisieren – Verallgemeinern](#5245-abstrahieren--spezialisieren--verallgemeinern)
    - [5.3 Die Struktur der Ausgangsdaten](#53-die-struktur-der-ausgangsdaten)
  - [7.4 Datenbankdesign](#74-datenbankdesign)
    - [7.4.1 Zielsetzung Datenbankdesign](#741-zielsetzung-datenbankdesign)
    - [7.4.2 Grundstruktur der Datenbank](#742-grundstruktur-der-datenbank)
    - [5.5 Dimension Rechtssubjekt (Raum) (Wer? / Wo?)](#55-dimension-rechtssubjekt-raum-wer--wo)
      - [5.5.1 Geographischer Raum](#551-geographischer-raum)
      - [5.5.3 Externe Effekte berücksichtigen](#553-externe-effekte-bercksichtigen)
    - [5.5.5 Dimension Zeit (Wann?)](#555-dimension-zeit-wann)
    - [7.6 Dimension Wertansatz](#76-dimension-wertansatz)
    - [5.5.7 Dimension Vermögen](#557-dimension-vermgen)
    - [5.11 Teil-Bereiche einer kommunalen Rechnungslegung](#511-teil-bereiche-einer-kommunalen-rechnungslegung)
    - [11.2 Erkenntnisgewinn der Auszahlungskonten](#112-erkenntnisgewinn-der-auszahlungskonten)
    - [11.4 Sprachlich und fachlich klare, einheitliche und präzise Bezeichnungen der Konten](#114-sprachlich-und-fachlich-klare-einheitliche-und-przise-bezeichnungen-der-konten)
    - [11.5 Überflüssige Zusätze weg lassen](#115-berflssige-zustze-weg-lassen)
    - [5.5.9 Wertansätze](#559-wertanstze)
    - [5.5.10 Abgrenzungen und Begriffswahl](#5510-abgrenzungen-und-begriffswahl)
      - [11.8 Sparkassen](#118-sparkassen)
      - [5.5.11 Leistungen](#5511-leistungen)
    - [Vergleichbarkeit von Leistungen](#vergleichbarkeit-von-leistungen)
      - [5.5.12 Leistungsspezifikation](#5512-leistungsspezifikation)
      - [5.5.13 Neue Finanzpositionen](#5513-neue-finanzpositionen)
- [Glossar](#glossar)
